...
$AFFECTED = ['files', 'servers_nas', 'database', 'virtual_machine', 'backup', 'leak_threat', 'unsure'];
$IMPACTS = ['stopped', 'partial', 'none', 'unsure'];
$LABELS = [
    'customer_type' => ['individual' => ['ar' => 'فرد', 'en' => 'Individual'], 'business' => ['ar' => 'شركة أو جهة', 'en' => 'Company or organisation']],
    'contact_method' => ['call' => ['ar' => 'اتصال', 'en' => 'Call'], 'whatsapp' => ['ar' => 'واتساب', 'en' => 'WhatsApp'], 'email' => ['ar' => 'بريد إلكتروني', 'en' => 'Email']],
    'affected' => ['files' => ['ar' => 'ملفات', 'en' => 'Files'], 'servers_nas' => ['ar' => 'خوادم/NAS', 'en' => 'Servers/NAS'], 'database' => ['ar' => 'قواعد بيانات', 'en' => 'Databases'], 'virtual_machine' => ['ar' => 'بيئات افتراضية', 'en' => 'Virtual environments'], 'backup' => ['ar' => 'نسخ احتياطية', 'en' => 'Backups'], 'leak_threat' => ['ar' => 'تهديد تسريب', 'en' => 'Leak threat'], 'unsure' => ['ar' => 'غير متأكد', 'en' => 'Not sure']],
    'impact' => ['stopped' => ['ar' => 'توقف العمل', 'en' => 'Work has stopped'], 'partial' => ['ar' => 'تأثر جزئي', 'en' => 'Partly affected'], 'none' => ['ar' => 'لا يوجد توقف حالي', 'en' => 'No current stoppage'], 'unsure' => ['ar' => 'غير متأكد', 'en' => 'Not sure']],
];
