...
module.exports = [
  {
    ...
    ar: {
      ...
      metaDesc: "استعادة بيانات في الرياض: المختبر داخل المدينة، ويمكنك تسليم الجهاز بنفسك. فحص وتشخيص مجاني بلا التزام للأقراص الصلبة وSSD وRAID وكاميرات المراقبة.",
      ...
      why: [
        ...
        },
        {
          ...
          b: "بين مجمعات الحاسب ومحلات تصليح الأقراص الصلبة في الرياض، من السهل أن يُشغَّل القرص ويُفحص ببرامج قبل أن يصل إلينا. إن حدث ذلك، نوثّقه أولاً، لأنه يحدد ما تبقّى من فرص ولا يظهر في الفحص وحده."
        },
        {
          t: "مكاتب صغيرة تعتمد على جهاز واحد",
          b: "مكاتب المحاسبة والمقاولات والعيادات في العليا وعلى طريق الملك فهد كثيراً ما تحفظ كل شيء على محطة عمل أو خادم واحد. وجودنا في نفس المدينة يعني أن المسؤول عن البيانات يمكنه الحضور، ويرى حالة الأقراص، ويقرر قبل أي محاولة."
        }
      ],
      ...
      faqs: [
        ...
        {
          q: "خادم مكتبنا في العليا توقف، هل نفكّ الأقراص ونحضرها؟",
    ...
    ar: {
      ...
      why: [
        ...
        },
        {
          ...
          b: "مكاتب الملاحة والتخليص الجمركي قرب الميناء تعتمد على قواعد بيانات وخوادم محاسبية. نبدأ بقراءة حالة الأقراص وتحديد ما يمكن قراءته، قبل أي إعادة بناء قد تطيل التوقف."
        },
        {
      ...
      faqs: [
        ...
        {
          q: "كيف أغلّف القرص الصلب قبل شحنه من جدة؟",
        ...
        {
          q: "عندي خادم أو RAID في مكتب بجدة، هل أشحن الأقراص كلها؟",
  ...
  },
  {
    ...
    ar: {
      ...
      metaDesc: "استرجاع بيانات الدمام والخبر والظهران والجبيل: خوادم، RAID، محطات عمل هندسية وأقراص. شحن آمن إلى مختبرنا في الرياض، وفحص وتشخيص مجاني بلا التزام.",
      heroHook: "في الشرقية، عطل واحد قد يوقف فريقًا كاملاً.",
      heroIntro: "في الدمام والخبر والظهران والجبيل قد لا يكون الجهاز المتوقف جهازًا شخصيًا: خادم ملفات، مصفوفة RAID، أو محطة عمل هندسية تحمل مخططات ونماذج مشروع قائم. في هذه الحالات يكون الضغط لإعادة التشغيل بسرعة هو أكبر خطر على البيانات. أوقف النظام أولًا، ثم اسأل.",
      ...
      why: [
        ...
        {
          t: "غرف خوادم بلا مختص تخزين مقيم",
          b: "كثير من الشركات هناك تدير الخادم عبر مزود خارجي يزور الموقع بين فترة وأخرى. عند فشل قرص يكون أول رد فعل هو بدء Rebuild لإعادة الخدمة بسرعة، وهذا قد يضاعف الضرر قبل أن يفحص أحد بنية المصفوفة وترتيب الأقراص."
        },
        {
      ...
      faqs: [
        {
          q: "ليس لديكم فرع في الدمام. كيف أرسل الخادم أو الأقراص؟",
          a: "المختبر في الرياض فقط، والوسائط تصل شحنًا. نتفق أولًا على تفاصيل الحالة عن بُعد، ويمكن توقيع اتفاقية عدم إفصاح قبل إخراج الأقراص من غرفة الخوادم. ترتيب الشحن وتكلفته على المنشأة، ويُفضَّل حساب شحن باسمها لتبقى الشحنة تحت تتبعها حتى تصل. ونبلغك عند الاستلام بما وصل وحالته الظاهرة."
        },
        {
          q: "هل أرسل الخادم كاملاً أم الأقراص فقط؟",
