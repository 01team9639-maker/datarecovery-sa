...
module.exports = {
  ar: {
    ...
    hero: {
      ...
      paras: [
        "نحن جهة متخصصة في استعادة البيانات من الأقراص الصلبة، وأقراص SSD وNVMe، وأنظمة RAID والخوادم، والهواتف، وبطاقات الذاكرة، وأنظمة المراقبة، إضافة إلى حالات الحذف والتهيئة وهجمات الفدية.",
    ...
    fields: {
      ...
      rows: {
        hdd: "حالات عدم ظهور القرص، الأصوات غير الطبيعية، الأعطال الإلكترونية والميكانيكية، تلف نظام الملفات، والحذف أو التهيئة.",
        "ssd-nvme": "حالات تعطل وحدة التحكم أو الـFirmware، وعدم التعرّف على القرص، والحذف أو التهيئة، مع مراعاة طبيعة ذاكرة NAND وتأثير TRIM.",
        ...
        "memory-cards": "حالات الحذف والتهيئة وعدم التعرّف على الوسيط والتلف المنطقي أو الكهربائي في بطاقات SD وmicroSD ووسائط USB."
      }
    },
