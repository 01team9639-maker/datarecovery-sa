...
module.exports = [
  {
    ...
    ar: {
      ...
      cardTitle: "خادم ملفات مشروع ونسخ متصلة به",
      ...
      title: "استعادة خادم ملفات مشروع بعد تشفير المشاركات",
      metaTitle: "حالة: خادم مشروع مقاولات بعد الفدية | من الصفر إلى الواحد",
      metaDesc: "حالة نموذجية تشرح مسار التعامل مع تشفير خادم ملفات في مكتب مقاولات: ما فُحص، وما استُعيد، وما لم يُستعد.",
      hook: "حالة نموذجية تشرح المسار",
      lead: "مكتب هندسة ومقاولات يعمل على مشاريع متزامنة. المخططات وجداول الكميات وعروض الأسعار والمستخلصات كلها على مشاركة شبكة واحدة، ويصل إليها المهندسون من المكتب ومن مواقع المشاريع عبر VPN. النسخة الاحتياطية اليومية تُكتب إلى قرص خارجي يبقى موصولًا بالخادم نفسه.",
      systemsTitle: "ما تأثّر",
      systems: [
        "خادم ملفات ويندوز يحمل مشاركات المشاريع.",
      ...
      tried: [
        "إعادة تشغيل الخادم عدة مرات على أمل أن تعود المشاركة.",
        "تثبيت مضاد فيروسات على الخادم نفسه وتشغيل فحص كامل.",
        "تغيير امتداد بعض الملفات يدويًا لمحاولة فتحها.",
        "توصيل قرص خارجي ثانٍ لنسخ ما يمكن إنقاذه."
      ],
      pathTitle: "مسار العمل",
      path: [
        { t: "عزل قبل أي قراءة", b: "فُصل الخادم عن الشبكة، وأُوقفت محطات العمل عن الوصول إلى المشاركة، وفُصل القرص الخارجي وعومل كمصدر لا كوجهة." },
        { t: "نسخة قبل التحليل", b: "أُنشئت نسخ من الخادم ومن القرص الخارجي، وجرى كل ما بعدها على النسخ لا على الأصل." },
        { t: "قراءة الرسالة والامتداد", b: "فُحصت رسالة الفدية وامتداد الملفات وتوقيت أول ملف مشفّر، وقُورنت عيّنة مشفّرة بنسخة أصلية وُجدت على الحاسوب المحمول لمهندس لم يكن متصلًا." },
        ...
        { t: "الاستعادة إلى بيئة نظيفة", b: "استُعيد ما أمكن إلى وسيط منفصل، ولم تُعد الملفات إلى الخادم قبل إعادة بنائه." }
      ],
  ...
  },
  {
    ...
    ar: {
      ...
      cardBody: "سلسلة متاجر صغيرة: تشفّر خادم المخزون والطلبات، فاستمر البيع من أجهزة نقاط البيع بلا رصيد صحيح.",
      ...
      hook: "حالة نموذجية تشرح المسار",
      lead: "سلسلة متاجر صغيرة بعدّة فروع ومتجر إلكتروني. نقاط البيع تعمل محليًّا في كل فرع وتزامن حركاتها إلى خادم مركزي يحمل المخزون والطلبات وبيانات العملاء. حين تشفّر الخادم المركزي، استمر البيع من أجهزة نقاط البيع — لكن بلا رصيد صحيح ولا ربط بالطلبات الإلكترونية.",
      systemsTitle: "ما تأثّر",
      systems: [
  ...
  },
  {
    ...
    ar: {
      ...
      tried: [
        ...
        "نسخ ما يظهر سليمًا إلى وحدة USB والعمل عليها مباشرة."
      ],
      pathTitle: "مسار العمل",
      path: [
