...
module.exports = {
  hdd: {
    ar: {
      ...
      expand: [
        {
          ...
          "title": "ما نوع عطل القرص الصلب؟",
          "lead": "لكل نوع مسار مختلف، والخطأ الشائع أن يُعامَل عطل مادي كأنه عطل برمجي.",
          "items": [
            {
              "t": "عطل منطقي",
              "b": "يظهر القرص الصلب طبيعيًّا لكن القسم اختفى، أو أصبح RAW، أو يطلب النظام تهيئته، أو حُذفت ملفات ومجلدات. الأولوية منع أي كتابة جديدة، ثم العمل على نسخة."
            },
            {
              "t": "قراءة غير مستقرة",
        ...
        },
        {
          ...
          "items": [
            ...
            {
              "t": "آخر حدث قبل العطل",
              "b": "سقوط، كهرباء، ماء، بطء، تهيئة أو حذف."
            },
            {
      ...
      devices: [
        ...
        {
          t: "Toshiba وHGST",
          b: "أقراص Toshiba مقاس 2.5 شائعة في الحواسيب المحمولة والعلب الخارجية، وHGST أكثر حضوراً في الخوادم مقاس 3.5. عند الحاجة إلى قطع بديلة تُطابق حسب العائلة وإصدار الـFirmware، لا حسب رقم الطراز على الملصق."
        },
        {
      ...
      steps: [
        ...
        {
          t: "تشغيل قصير ومراقب",
          b: "تشغيلة واحدة قصيرة تجيب على ثلاثة أسئلة: هل يصل القرص إلى وضع الجاهزية، هل يعلن الطراز والسعة الصحيحة، وهل تُقرأ منطقة الخدمة. عند سماع صوت رؤوس غير طبيعي تتوقف الطاقة فوراً وينتقل العمل إلى بيئة هواء نظيف داخل المختبر."
        },
        {
  ...
  "ssd-nvme": {
    ar: {
      ...
      expand: [
        {
          ...
          "lead": "أقراص SSD وNVMe لا تتصرّف مثل القرص الصلب الميكانيكي، ونتيجة الحذف عليها تختلف جذريًّا.",
          "items": [
            {
            ...
            },
            {
              ...
              "b": "قد تدخل بعض الأقراص وضع حماية عند اكتشاف مشكلة داخلية. لا تحاول إجبار الكتابة أو التهيئة — قد تكون هذه آخر فرصة لنسخ المحتوى."
            },
            {
              "t": "حُذفت الملفات أو أُجريت تهيئة",
        ...
        },
        {
          ...
          "items": [
            ...
            {
              "t": "آخر حدث قبل العطل",
              "b": "تحديث، انقطاع طاقة، سقوط، تهيئة، حذف أو اختفاء."
            },
            {
      ...
      devices: [
        ...
        {
          t: "WD وSanDisk",
          b: "أقراص WD وSanDisk شائعة في الحواسيب المحمولة وفي الأقراص الخارجية بمنفذ USB. في النسخ الخارجية تكون الذاكرة أحياناً ملحومة مع وحدة التحكم على لوحة واحدة، فلا يوجد قرص يمكن إخراجه، ويتحدد المسار بحالة تلك اللوحة."
        },
        {
        ...
        {
          t: "سلوك TRIM",
          b: "بعد الحذف أو التهيئة يرسل النظام أمر TRIM، وقد تستمر وحدة التحكم في مسح تلك المساحات في الخلفية حتى والقرص غير مستخدم. التوقف المبكر عن التشغيل يغيّر الفرص أكثر من أي أداة تُستخدم لاحقاً."
        }
      ],
      ...
      steps: [
        ...
        },
        {
          ...
          b: "يُوصل القرص عبر مسار يمنع الكتابة مع تعطيل التهيئة التلقائية وأمر TRIM، ثم تُقرأ هوية وحدة التحكم: هل يعلن الطراز والسعة الصحيحة، أم يظهر بسعة صفر أو في وضع اضطراري. إذا ظهر مستقراً يُنسخ في الجلسة نفسها بمرور واحد وبعمق طلبات منخفض، لأن أقراص SSD غالباً تتوقف دفعة واحدة لا تدريجياً."
        },
        {
      ...
      caseTitle: "حالة نموذجية: حاسوب محمول توقف عن الإقلاع وقرص M.2 يظهر بسعة خاطئة",
      caseBody: "حالة نموذجية: حاسوب محمول توقف عن الإقلاع فجأة. يظهر قرص M.2 من نوع NVMe في إعدادات BIOS لكن بسعة غير صحيحة، وكان صاحبه قد أعاد التشغيل عدة مرات وجرّب علبة خارجية. وصل الجهاز إلى المختبر دون محاولة تحديث Firmware. وُصل القرص عبر مانع كتابة مع تعطيل TRIM، فاتضح أن وحدة التحكم دخلت وضع حماية يسمح بالقراءة فقط. نُسخ القرص بمرور واحد في تلك الجلسة، ثم أُعيد بناء نظام الملفات من النسخة.",
    ...
    ar: {
      ...
      expand: [
        ...
        },
        {
          ...
          "items": [
            "لا تبدأ Rebuild ثانيًا ولا تُجرِ عملية تهيئة أولية (Initialize).",
        ...
        },
        {
          ...
          "items": [
            {
              "t": "الجهاز والمتحكّم",
              "b": "الشركة والطراز للخادم أو NAS أو SAN، وطراز المتحكّم."
            },
            {
              "t": "إعداد المصفوفة",
      ...
      devicesTitle: "الخوادم وأنظمة التخزين التي نتعامل معها",
      ...
      steps: [
        {
          ...
          b: "نسجّل نوع RAID، عدد الأقراص، رقم كل منفذ، طراز المتحكم ورسائل السجل. يُوسم ترتيب الأقراص فيزيائياً، ولا تُكتب أي بيانات على قرص عضو."
        },
        {
  ...
  cctv: {
    ar: {
      ...
      expand: [
        {
          ...
          "items": [
            ...
            {
              "t": "أجرى الجهاز تهيئة للقرص الصلب",
            ...
            },
            {
              ...
              "b": "قد تكون المشكلة في الجهاز أو مصدر الطاقة أو القرص أو بنية التخزين. لا تنقل القرص الصلب إلى جهاز آخر قد يهيّئه تلقائيًّا؛ احتفظ بالجهاز والقرص ومحوّل الطاقة."
            },
            {
        ...
        },
        {
          ...
          "paras": [
            "قد تكون التسجيلات على قرص صلب داخل DVR، أو مجموعة أقراص داخل NVR، أو بطاقة ذاكرة في الكاميرا، أو NAS، أو خدمة سحابية. تختلف طريقة الاستعادة بحسب مكان التخزين، ولذلك لا يكفي اسم ماركة الكاميرا وحده.",
        ...
        },
        {
          ...
          "items": [
            ...
            },
            {
              ...
              "b": "يُقرأ القرص الصلب بطريقة تمنع الكتابة عليه. وإذا كان متضرّرًا، تُعالَج مشكلة القراءة أولًا ثم يستمرّ التحليل على النسخة."
            },
            {
        ...
        },
        {
          ...
          "items": [
            ...
            "لا تُجرِ تهيئة أولية (Initialize) أو تهيئة (Format) للقرص الصلب.",
        ...
        },
        {
          ...
          "items": [
            ...
            {
              "t": "ما حدث",
              "b": "حذف، تهيئة، إعادة ضبط (Reset)، عطل جهاز، عطل قرص صلب أو تصدير فاشل."
            },
            {
              "t": "التسجيل بعد الفقد",
      ...
      devices: [
        ...
        {
          t: "أقراص المراقبة WD Purple وSeagate SkyHawk",
      ...
      steps: [
        {
          ...
          b: "نسجّل طراز الجهاز، عدد القنوات، والتاريخ والساعة المطلوبين. من حجم القرص وعدد الكاميرات ومعدل البث نقدّر مدة الاحتفاظ الفعلية، وهل ما زالت النافذة المطلوبة داخل القرص أصلاً."
        },
        {
  ...
  "after-format": {
    ar: {
      ...
      expand: [
        {
          ...
          "lead": "كلمة «التهيئة» (Format) تصف أفعالًا مختلفة جدًّا، ولكلٍّ منها نتيجة مختلفة.",
          "items": [
            {
              "t": "تهيئة سريعة",
        ...
        },
        {
          ...
          "items": [
            {
              "t": "HDD",
              "b": "قد تبقى محتويات كثيرة بعد تهيئة سريعة إذا لم تتمّ الكتابة فوقها. يمكن تحليل بيانات نظام الملفات أو البحث عن الملفات بحسب بنيتها، مع احتمال فقد الأسماء والمجلدات إذا تضرّرت البيانات الوصفية."
            },
            {
              "t": "SSD وNVMe",
            ...
            {
              "t": "بطاقات الذاكرة ووحدات USB",
              "b": "تعتمد النتيجة على وحدة التحكّم ونظام الملفات واستخدام البطاقة بعد التهيئة. التصوير الجديد قد يستبدل المقاطع القديمة بسرعة، وبعض الفيديوهات تحتاج إعادة تجميع حتى لو عادت بياناتها الخام."
            },
            {
              "t": "قرص مشفّر",
        ...
        },
        {
          ...
          "items": [
            ...
            {
              "t": "‏SSD أُجريت له تهيئة واستمرّ استخدامه",
            ...
            {
              "t": "بطاقة كاميرا أُجريت لها تهيئة ثم استمرّ التصوير",
              "b": "قد تُستبدل المقاطع بالتسلسل، فتعود تسجيلات أحدث بينما تتضرّر الأقدم. توقّف عن التصوير وحدّد التاريخ والملفات المطلوبة."
            },
            {
              "t": "القرص يطلب التهيئة دون أن يُجري المستخدم أي تهيئة",
              "b": "ليست حالة «بعد التهيئة» بالضرورة: قد يكون نظام الملفات تالفًا أو القرص غير مستقرّ. لا توافق على الرسالة، وتُقيَّم الحالة كعطل منطقي أو مادي."
            }
          ]
        },
        {
      ...
      devicesTitle: "الأجهزة وأنظمة الملفات التي نفحصها بعد التهيئة",
      devicesLead: "التهيئة ليست عملية واحدة. ما يبقى من البيانات يعتمد على نظام الملفات، ونوع التهيئة، والوسيط نفسه. لذلك يبدأ الفحص بتحديد هذه الثلاثة قبل أي قراءة.",
      devices: [
        {
          t: "أقراص Windows بنظام NTFS",
          b: "التهيئة السريعة تكتب جدول ملفات جديداً صغيراً فوق بداية القسم فقط، وقد تبقى سجلات جدول الملفات القديم ($MFT) في مكانها. التهيئة الكاملة حالة مختلفة تماماً، لأنها تمر على القسم كله."
        },
        {
          t: "وحدات USB وبطاقات بنظام exFAT وFAT32",
        ...
        {
          t: "خوادم لينكس وأقراص NAS بنظام ext4",
        ...
        },
        {
          ...
          b: "بعد التهيئة قد يرسل النظام أوامر TRIM تُفرغ الصفحات فعلياً، لا أن تعلّم المساحة كفارغة فقط. لهذا يُفصل القرص عن التشغيل مباشرة، ويُقاس ما إذا كان يعيد أصفاراً قبل أي محاولة."
        }
      ],
      stepsTitle: "كيف نتعامل مع حالة بعد التهيئة",
      steps: [
        {
      ...
      caseTitle: "حالة نموذجية: تهيئة سريعة قبل إعادة تثبيت النظام",
      caseBody: "حاسوب محمول أُعيد تثبيت Windows عليه بعد تهيئة سريعة، ثم اكتشف صاحبه أن مجلد المستندات والصور لم يكن ضمن النسخة الاحتياطية. أوقف الجهاز بعد ساعات من الاستخدام، وهذا يعني أن النظام الجديد كتب فوق بداية القسم دون بقيته. أخذنا نسخة قطاعية كاملة، ثم بحثنا عن سجلات جدول الملفات القديم خارج المساحة التي شغلها التثبيت الجديد.",
      caseResult: "عاد جزء كبير من الصور والمستندات بأسمائه ومجلداته، وعاد جزء آخر عبر التواقيع دون أسماء. الملفات التي وقعت تحت مساحة التثبيت الجديد لم تكن قابلة للاستعادة. هذه نتيجة حالة واحدة، وتختلف حسب حجم الاستخدام بعد التهيئة."
    },
    en: {
      /* التوسعة العميقة — خطة العميل. اختيارية ويعرضها serviceExpansion()
         بمفردات تصميم الموقع نفسها، بلا ادعاءات قدرة جديدة. */
  ...
  ransomware: {
    ar: {
        ...
        expand: [
          {
            ...
            items: [
              ...
              { t: "خادم أو شبكة شركة توقّفت", b: "تأثّرت مشاركات الشبكة أو حسابات المستخدمين أو أكثر من جهاز في الوقت نفسه." },
          ...
          },
      {
        ...
        lead: "القطاعات مأخوذة من بحث التهديدات السعودي: الإنشاءات، التصنيع، التقنية، التجزئة، الصحة، والنقل. وكل حالة تشرح ما فُحص، وما استُعيد، وما لم يُستعد."
      },
          {
            ...
            paras: [
              "فيروس الفدية برمجية خبيثة تمنع الوصول إلى الملفات أو الأنظمة، ثم يطلب المهاجم مقابلًا ماليًا لاستعادة الوصول أو لمنع نشر بيانات يدّعي أنه سرقها. قد يقتصر الهجوم على جهاز واحد، وقد ينتقل عبر الشبكة فيصل إلى الخوادم ووحدات التخزين المشتركة والنسخ الاحتياطية والخدمات السحابية المتزامنة.",
      ...
      caseTitle: "حالة نموذجية: خادم ملفات وقاعدة بيانات في إصابة واحدة",
      caseBody: "شركة صغيرة استيقظت على امتداد جديد على كل الملفات، ورسالة فدية في كل مجلد. مشاركة NAS كانت متصلة بالخادم وقت الإصابة فأصابها التشفير كذلك، ونسخ Shadow Copies كانت محذوفة. أوقفنا كل شيء وأخذنا نسخاً قطاعية، ثم قارنّا الملفات المشفرة بأصول من نفس الصيغة، وفحصنا المساحة غير المخصصة على الخادم وعلى وحدة NAS بحثاً عن أصول حُذفت بعد التشفير.",
      ...
      expand: [
          ...
          "items": [
            {
              ...
              "b": "قد يكون المسار إصلاح الوصول المؤقّت إلى الشاشة أو منفذ البيانات، مع بقاء رمز القفل ضروريًّا في الأجهزة المشفّرة. لا تُجرِ إعادة ضبط (Reset) ولا تغيّر الحساب."
            },
            {
            ...
            },
            {
              ...
              "b": "قد تكون المشكلة برمجية أو في التخزين أو اللوحة. لا تُجرِ استعادة للنظام (Restore) أو إعادة ضبط لإعدادات المصنع (Factory Reset) إذا كانت البيانات في الأولوية، ولا تثبّت تحديثًا قبل تقييم أثره."
            },
            {
        ...
        },
        {
          ...
          "paras": [
            ...
            "والهدف في حالة اللوحة المتضرّرة هو إقلاع مستقرّ يكفي للوصول إلى البيانات، وليس بالضرورة إعادة الهاتف للاستخدام اليومي. وقد تتطلّب العملية فتح الجهاز أو العمل على اللوحة، ويجب توضيح أثر ذلك على الضمان أو مقاومة الماء أو قابلية الاستخدام قبل البدء."
          ]
        },
        {
          "kind": "steps",
  ...
  "memory-cards": {
    ar: {
      ...
      expand: [
        {
          ...
          "items": [
            ...
            {
              "t": "حُذفت صور أو أُجريت تهيئة ثم استمرّ التصوير",
        ...
        },
        {
          ...
          "items": [
            ...
            },
            {
              ...
              "b": "هل تمّت التهيئة أو التصوير أو النسخ، وكم تقريبًا."
            },
            {
              "t": "الحالة المادية",
      ...
      devicesLead: "ما يحدد طريقة القراءة هو نوع الشريحة ووحدة التحكم داخل الوسيط وطريقة تجميعهما. هذه أكثر البطاقات ووحدات USB التي تصل المختبر.",
      devices: [
        {
          t: "SanDisk",
          b: "بطاقات SD وmicroSD ووحدات USB من SanDisk تعمل بوحدات تحكم وجداول ترجمة خاصة بها. كثير من بطاقات microSD منها مصبوبة في قطعة واحدة، فلا توجد شريحة تُفك، ويتم العمل على جسم البطاقة نفسه."
        },
        {
          t: "Lexar",
        ...
        {
          t: "Samsung",
          b: "بطاقات EVO وPRO ووحدات USB من Samsung تجمع الشريحة ووحدة التحكم من المصنّع نفسه. العطل الشائع توقف مفاجئ: البطاقة تظهر بحجم خاطئ أو تتحول إلى وضع القراءة فقط، وهذه علامة وحدة تحكم لا علامة حذف."
        },
        {
          t: "Kingston",
        ...
        },
        {
          ...
          b: "الشكل يحدد طريقة الوصول. بطاقات CF تتصل عبر مسامير دقيقة قد تلتوي داخل الكاميرا، أما CFexpress فهي عملياً قرص NVMe داخل غلاف بطاقة، فتُعامل معاملة SSD لا معاملة بطاقة SD."
        },
        {
      ...
      caseTitle: "بطاقة SD طلبت تهيئة بعد تغطية مناسبة",
      caseBody: "حالة نموذجية: بطاقة SD تعمل في كاميرا احترافية، ظهرت عليها رسالة خطأ في نهاية التصوير، وعند توصيلها بالحاسب طلبت تهيئة. جُرّب برنامج استرجاع مجاني ثم توقف الاستخدام، دون تهيئة ودون تصوير جديد. تصل البطاقة إلى المختبر وتظهر لكن قراءتها متعثرة. نأخذ نسخة كاملة بقراءة بطيئة، ثم نعمل على النسخة وحدها: جدول الملفات متضرر، لذلك تُجمع المقاطع من بنيتها الداخلية بدل الاعتماد عليه.",
      caseResult: "في كثير من الحالات المشابهة تعود الصور والمقاطع كاملة أو شبه كاملة، ما دامت التهيئة لم تتم ولم يُصوَّر على البطاقة بعدها. وإذا كانت الكتابة قد طالت أجزاء من المقاطع، فقد يعود بعضها ناقصاً أو لا يعود. نعرض ما ظهر في النسخة قبل أي وعد."
    },
    en: {
      /* التوسعة العميقة — خطة العميل. اختيارية ويعرضها serviceExpansion()
         بمفردات تصميم الموقع نفسها، بلا ادعاءات قدرة جديدة. */
