...
module.exports = [
  {
    ...
    icon: "HDD",
    ar: {
      title: "استرجاع ملفات من قرص صلب تالف أو لا يعمل",
      metaTitle: "استرجاع ملفات من قرص صلب تالف أو لا يعمل | من الصفر إلى الواحد",
      ...
      heroHook: "القرص الصلب لا يظهر؟ لا تشغّله مرة ثانية.",
      heroIntro: "إذا كان القرص الصلب لا يظهر، أو يصدر صوت طقطقة، أو توقف بعد سقوط أو انقطاع كهرباء، فالأهم عدم تكرار المحاولة. كل تشغيل إضافي قد يزيد الضرر.",
      symHook: "الصوت الغريب ليس تفصيلاً صغيراً.",
      symTitle: "متى تحتاج إلى فحص القرص الصلب؟",
      symptoms: [
        { t: "القرص الصلب لا يظهر", b: "الجهاز لا يتعرّف على القرص أو يطلب تهيئته عند التوصيل." },
      ...
      diagTitle: "هل يمكن استرجاع ملفات من قرص صلب لا يعمل؟",
      ...
      warnBody: "لا تفتح القرص الصلب. لا تكرر تشغيله إذا كان يصدر صوتاً. لا تستخدم برامج استرجاع على قرص غير مستقر، ولا تُجرِ تهيئة عندما يطلب النظام ذلك.",
      faqHook: "قبل أن تعيد تشغيله، اقرأ هذا.",
      faqs: [
        { q: "هل يمكن استرجاع بيانات قرص صلب يصدر صوت طقطقة؟", a: "قد يشير الصوت إلى عطل فيزيائي، لذلك يجب إيقاف القرص الصلب وعدم تشغيله قبل الفحص." },
        { q: "هل يمكن استعادة بيانات قرص صلب خارجي لا يظهر؟", a: "نعم، يمكن فحص الكابل والغلاف والدائرة الإلكترونية والقرص نفسه لتحديد السبب." },
        { q: "هل برامج الاسترجاع تنفع مع القرص الصلب التالف؟", a: "قد تفيد في الحذف البسيط، لكنها قد تكون خطيرة مع العطل الفيزيائي أو القراءة غير المستقرة." }
      ],
  ...
  },
  {
    ...
    ar: {
      ...
      heroHook: "SSD اختفى؟ لا تتعامل معه كقرص صلب عادي.",
      ...
      diagBody: "أقراص NVMe وM.2 شائعة في الحواسيب المحمولة ومحطات العمل. قد يكون العطل مرتبطاً بطريقة قراءة القرص أو إدارة البيانات داخله؛ لذلك يتم فحص النوع، حالة الظهور وطبيعة الخطأ قبل تحديد إمكانية الاستعادة.",
  ...
  },
  {
    ...
    icon: "RAID",
    ar: {
      title: "استعادة بيانات RAID والخوادم للشركات",
      metaTitle: "استعادة بيانات RAID والخوادم | من الصفر إلى الواحد",
      metaDesc: "استعادة بيانات مصفوفات RAID والخوادم وأنظمة NAS وSAN للشركات. تحليل المصفوفة قبل أي إعادة بناء. الرياض، السعودية.",
      heroHook: "فشل قرص واحد لا يعني أن كل شيء انتهى.",
      heroIntro: "عند تعطل RAID أو توقف الخادم عن قراءة البيانات، إعادة التشغيل المتكرر أو بدء Rebuild جديد دون فحص قد يضاعف المشكلة.",
      ...
      symptoms: [
        ...
        { t: "توقف الوصول للملفات", b: "المجلدات المشتركة أو خدمات الخادم لم تعد متاحة." },
  ...
  },
  {
    ...
    ar: {
      ...
      metaDesc: "استرجاع تسجيلات كاميرات المراقبة المحذوفة أو المفقودة من أجهزة DVR وNVR وأقراص التسجيل الصلبة. فحص أنظمة Hikvision وDahua. الرياض، السعودية.",
      heroHook: "التسجيل اختفى؟ الوقت الآن جزء من المشكلة.",
      heroIntro: "يمكن فحص التسجيلات المحذوفة أو المفقودة من DVR وNVR وأقراص التسجيل الصلبة. إمكانية الاستعادة تتأثر بمدة التسجيل بعد الفقد وحالة القرص وطريقة التخزين.",
      ...
      symptoms: [
        ...
        { t: "قرص تسجيل تالف", b: "تعرض القرص لعطل أو أُجريت له تهيئة بالخطأ." }
      ],
      diagHook: "DVR وNVR لا يخزّنان الفيديو كملف عادي.",
      diagTitle: "استعادة تسجيلات DVR وNVR",
      diagBody: "أجهزة التسجيل تعمل بصورة مستمرة وقد تستبدل المقاطع القديمة تلقائياً. يمكن فحص أنظمة Hikvision وDahua حسب نوع الجهاز وحالة القرص الصلب ونظام التخزين قبل الحكم على إمكانية الاستعادة.",
      warnTitle: "أوقف التسجيل فوراً",
      warnBody: "كل دقيقة تسجيل جديدة قد تستبدل جزءاً من المقاطع المطلوبة. أوقف الجهاز أو افصل قرص التسجيل قبل أي إعادة تشغيل أو تهيئة.",
      faqHook: "قبل إعادة التشغيل أو التهيئة.",
      faqs: [
        { q: "هل يمكن استرجاع التسجيلات بعد الحذف؟", a: "يمكن ذلك في بعض الحالات، خصوصاً إذا لم تتم الكتابة فوق المقاطع المطلوبة." },
        { q: "هل يمكن استعادة DVR بعد التهيئة؟", a: "تعتمد النتيجة على نوع التهيئة وحالة القرص الصلب وما إذا تم تسجيل بيانات جديدة." },
        { q: "هل يمكن استعادة تسجيلات Hikvision؟", a: "يمكن فحص أجهزة Hikvision وأقراصها الصلبة وتحديد إمكانية الاستعادة حسب الحالة." }
      ],
      ctaHook: "أوقف التسجيل واحفظ فرصة الاستعادة.",
      ctaBody: "أرسل نوع الجهاز، التاريخ المطلوب وحالة القرص الصلب. نقيّم الحالة قبل أن تتم الكتابة فوق التسجيلات."
    },
    en: {
  ...
  },
  {
    ...
    icon: "FORMAT",
    ar: {
      title: "استعادة البيانات بعد التهيئة واسترجاع الملفات المحذوفة",
      metaTitle: "استعادة البيانات بعد التهيئة | من الصفر إلى الواحد",
      metaDesc: "استعادة البيانات بعد التهيئة واسترجاع الملفات المحذوفة من الأقراص ووحدات USB وبطاقات الذاكرة. أوقف الاستخدام قبل أن تُستبدل البيانات. الرياض، السعودية.",
      heroHook: "هل أجريت تهيئة للقرص؟ لا تنسخ إليه أي ملفات جديدة.",
      heroIntro: "التهيئة لا تعني دائماً أن الملفات اختفت نهائياً، لكن استخدام الجهاز بعده قد يقلل فرصة الاسترجاع. أوقف الاستخدام ولا تنسخ أي بيانات جديدة.",
      symHook: "المساحة الفارغة قد لا تكون فارغة فعلاً.",
      symTitle: "هل يمكن استرجاع الملفات بعد التهيئة؟",
      symptoms: [
        { t: "قرص صلب أو SSD", b: "تمت تهيئة القرص أو حذف القسم بالخطأ." },
        { t: "وحدة USB أو بطاقة SD", b: "اختفت الصور أو الملفات بعد التهيئة." },
        { t: "ملفات محذوفة", b: "تم حذف صور أو مستندات أو فيديوهات مهمة." }
      ],
      diagHook: "ما يحدث بعد التهيئة أهم من التهيئة نفسها.",
      diagTitle: "استرجاع الصور والمستندات بعد التهيئة",
      diagBody: "في حالات كثيرة تبقى البيانات قابلة للاستعادة إذا لم تتم كتابة بيانات جديدة فوق المساحة القديمة. تختلف النتيجة حسب نوع الجهاز، طريقة التهيئة وحجم الاستخدام بعد الفقد.",
      warnTitle: "لا تستخدم الجهاز",
      warnBody: "لا تنسخ ملفات جديدة. لا تثبّت برامج استرجاع على نفس القرص ولا تكرر التهيئة. البيانات الجديدة قد تستبدل أجزاء من الملفات القديمة.",
      faqHook: "الفرصة تعتمد على ما فعلته بعده.",
      faqs: [
        { q: "هل تحذف التهيئة الملفات نهائياً؟", a: "ليس دائماً؛ قد تبقى البيانات قابلة للاستعادة إذا لم يتم استبدالها." },
        { q: "هل يمكن استرجاع الصور بعد التهيئة؟", a: "يمكن ذلك في حالات كثيرة، والنتيجة تعتمد على استخدام الجهاز بعد التهيئة." },
        { q: "هل يمكن استعادة بيانات SSD بعد التهيئة؟", a: "قد تكون أصعب بسبب طريقة إدارة البيانات، لذلك يجب فحص الحالة أولاً." }
      ],
      ctaHook: "توقّف قبل أن تُستبدل البيانات.",
      ctaBody: "أرسل نوع الجهاز وطريقة التهيئة وما حدث بعده. هذه التفاصيل تساعدنا على تقييم الفرصة بدقة."
    },
    en: {
  ...
  },
  {
    ...
    ar: {
      ...
      symptoms: [
        { t: "اعزل الجهاز", b: "أوقف استخدام الجهاز أو الخادم المتضرر قدر الإمكان." },
      ...
      diagBody: "يتم فحص نوع الإصابة، الملفات المشفرة والنسخ المتاحة. في بيئة الشركات نراجع الخوادم، وسائط التخزين والنسخ الاحتياطية لتحديد فرص الاسترجاع وتقليل أثر التوقف.",
  ...
  },
  {
    ...
    ar: {
      ...
      heroHook: "هل سقط هاتفك في الماء؟ لا تشغّله ولا تشحنه.",
      heroIntro: "إذا كان الهاتف متوقفًا عن العمل ولا يستجيب، أو دخله ماء، أو انكسرت شاشته، فالخطوة الأولى هي التوقف. كل محاولة تشغيل أو شحن قد تحوّل ضرراً مؤقتاً إلى ضرر دائم.",
      symHook: "الجوال الصامت ليس بالضرورة جوالاً فارغاً.",
      symTitle: "متى تحتاج إلى فحص الجوال؟",
      symptoms: [
        { t: "الهاتف لا يعمل", b: "توقف الجهاز عن العمل بعد سقوطه أو تعرضه للماء أو أثناء شحنه، ولا يستجيب لزر التشغيل أو الشاحن." },
        { t: "الشاشة مكسورة والجهاز يعمل", b: "الجهاز يعمل لكن الشاشة أو اللمس لا يستجيب، فلا يمكن إدخال رمز القفل." },
        { t: "صور اختفت أو أُجريت تهيئة", b: "حُذفت الصور من هاتف تالف، أو تمت إعادة ضبط المصنع على جهاز Android." }
      ],
      diagHook: "التشفير جزء من المعادلة، لا تفصيل جانبي.",
      diagTitle: "هل يمكن استعادة الصور من هاتف تالف؟",
      ...
      warnBody: "لا تشغّل الجهاز بعد الماء ولا تضعه في الأرز أو أمام مجفف الشعر؛ الحرارة والتيار قد يكملان التآكل داخل اللوحة. لا تُجرِ إعادة ضبط المصنع، ولا تسجّل الدخول بحساب جديد، ولا تثبّت برامج استرجاع على الجوال نفسه، فقد تكتب فوق ما تبحث عنه.",
      faqHook: "قبل أن تجرب الشحن مرة ثانية.",
      faqs: [
        { q: "سقط هاتفي في الماء؛ كيف يمكنني استعادة الصور؟", a: "أوقف الجهاز ولا تشحنه ولا تجففه بالحرارة. قد تكون الاستعادة ممكنة إذا لم يتقدم التآكل داخل اللوحة، ويحدد ذلك الفحص." },
        {
        ...
        {
          q: "هل يمكن استرجاع ملفات الاندرويد بعد إعادة ضبط المصنع أو التهيئة؟",
  ...
  },
  {
    slug: "memory-cards",
    ar: {
      title: "استرجاع ملفات من وحدات USB التالفة وبطاقات الذاكرة وبطاقات الكاميرات",
      metaTitle: "استرجاع ملفات وحدات USB وبطاقات الذاكرة | من الصفر إلى الواحد",
      metaDesc: "استرجاع ملفات من وحدات تخزين USB التالفة وبطاقات الذاكرة وبطاقات الكاميرات، وحالات طلب التهيئة وتلف وحدة التحكم. فحص أولاً قبل أي محاولة. الرياض، السعودية.",
      heroHook: "وحدة USB تطلب التهيئة؟ لا تضغط «موافق».",
      heroIntro: "إذا طلب النظام تهيئة البطاقة أو وحدة USB، أو توقفت البطاقة عن الظهور بعد التصوير، فقد تكون البيانات سليمة والمشكلة في طريقة الوصول إليها. كل محاولة إصلاح سريعة قد تغيّر ما تبقى.",
      symHook: "الحجم صغير، لكن الضرر يتراكم بسرعة.",
      symTitle: "متى تحتاج بطاقة الذاكرة أو وحدة USB إلى فحص؟",
      symptoms: [
        { t: "الجهاز يطلب تهيئة الوسيط", b: "رسالة «يجب تهيئة القرص قبل استخدامه» تظهر عند كل توصيل." },
        { t: "البطاقة لا تُقرأ في الكاميرا", b: "الكاميرا تعرض خطأ في البطاقة أو تظهر فارغة رغم وجود التصوير." },
        { t: "وحدة USB مكسورة أو ساخنة", b: "انكسر الطرف المعدني أو أصبحت الوحدة ساخنة ولا تظهر في أي جهاز." }
      ],
      diagHook: "الشريحة ليست قرصاً.",
      diagTitle: "استعادة فيديو محذوف من كاميرات سوني وكانون وGoPro",
      diagBody: "بطاقات SD وبطاقات الكاميرات ووحدات USB تخزّن البيانات في شرائح NAND تديرها وحدة تحكم. عند تلف وحدة التحكم أو انفصال الوصلات لا يظهر الوسيط أصلاً، وقد يتطلب الأمر قراءة الشريحة نفسها. في الوسائط المدمجة (Monolith) تكون الشريحة ووحدة التحكم في قطعة واحدة، لذلك يبدأ العمل بتحديد نوع الوسيط وحالة الاتصال قبل أي محاولة قراءة. مقاطع Sony وCanon وGoPro المحذوفة قد تكون قابلة للاستعادة حسب حالة الكتابة فوقها.",
      warnTitle: "لماذا تزيد برامج الاسترجاع الرخيصة الضرر؟",
      warnBody: "لا توافق على رسالة التهيئة. لا تُعِد إدخال وحدة USB المكسورة مرة بعد مرة، ولا تلحمها أو تلصقها بنفسك. برامج الاسترجاع الرخيصة تفترض أن الوسيط سليم، وقد تعيد كتابة جداول الملفات أو تستمر في الضغط على وحدة تحكم متضررة حتى تتوقف نهائياً. ولا تلتقط صوراً جديدة على نفس البطاقة.",
      faqHook: "قبل أن توافق على التهيئة.",
      faqs: [
        {
          q: "وحدة تخزين USB تطلب التهيئة؛ هل ينبغي تهيئتها؟",
        ...
        { q: "هل تنفع الاستعادة إذا انكسرت وحدة USB من المنتصف؟", a: "يمكن فحص الشريحة ووصلاتها في حالات الكسر، وتتحدد إمكانية الاستعادة بعد الفحص حسب سلامة الشريحة." }
      ],
      ctaHook: "لا تصوّر ولا تهيّئ قبل الفحص.",
      ctaBody: "أخرج البطاقة أو وحدة USB من الجهاز وأرسل نوع الوسيط ونوع الكاميرا والرسائل التي ظهرت. الفحص والتشخيص مجاني بلا التزام."
    },
    en: {
